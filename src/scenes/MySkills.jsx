      ...
      <div className="md:flex md:justify-between md:gap-16 mt-32">
        ...
        {/* <div className="mt-16 md:mt-0">
          {isAboveLarge ? (
            ...
            >
              <img alt="skills" className="z-10" src="assets/me.png" />
            </div>
          ) : (
      ...
      <div className="md:flex md:justify-between mt-16 gap-32 text-xl">
        ...
        >
          <div className="relative m-5">
            <div className="z-10">
              <p className="font-playfair font-semibold text-4xl m-5 flex flex-wrap">
                Technologies
              </p>

              <p className="font-playfair font-semibold m-5 flex flex-wrap max-w-[380px]">
                {" "}
                <a
